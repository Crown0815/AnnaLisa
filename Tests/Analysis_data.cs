...
namespace AnnaLisa.Testing
{
    public class Analysis_data
    {
        ...
        [Fact]
        public void can_have_a_single_set_of_two_dimensional_points()
        {
        ...
        [Fact]
        public void can_have_multiple_sets_of_two_dimensional_points()
        {
        ...
        [Fact]
        public void can_have_multiple_sets_of_points_and_units()
        {
            const string xUnit = "x";
            const string yUnit = "y";
            var points1 = new Point[] {(1, 1)};
